...
require __DIR__ . '/Services/UbigeoService.php';
...
require __DIR__ . '/Services/OrderConfirmationService.php';
require __DIR__ . '/Services/ReceiptDeliveryService.php';
require __DIR__ . '/Services/SecureDocumentService.php';
require __DIR__ . '/Services/ImageOptimizerService.php';
